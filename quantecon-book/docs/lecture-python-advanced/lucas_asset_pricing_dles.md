...
We use a linear-quadratic version of an economy that Lucas (1978) [[Luc78]](https://python-programming.quantecon.org/zreferences.html#lucas1978) used
...
[[HS13]](https://python-programming.quantecon.org/zreferences.html#hs2013) show that the time t value of a permanent claim to a stream

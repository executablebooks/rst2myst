...
This is a [sequel to an earlier lecture](https://python-programming.quantecon.org/tax_smoothing_1.html).
...
As shown in the [previous lecture](https://python-programming.quantecon.org/tax_smoothing_1.html),

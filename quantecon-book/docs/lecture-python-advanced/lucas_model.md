...
The elegant asset pricing model of Lucas [[Luc78]](https://python-programming.quantecon.org/zreferences.html#lucas1978) attempts to answer this question in an equilibrium setting with risk-averse agents.

...
Continuing in this way, and using our knowledge of [geometric series](https://python-programming.quantecon.org/geom_series.html), we find that, for any $ t \geq 0 $,

...
- [Complex Numbers and Trigonometry](#Complex-Numbers-and-Trigonometry)  
  ...
  - [Applications of de Moivre’s Theorem](#Applications-of-de-Moivre’s-Theorem)  
...
Samuelson (1939) [[Sam39]](https://python-programming.quantecon.org/zreferences.html#samuelson1939) in his classic paper on interactions
between the investment accelerator and the Keynesian consumption function, our
topic in the lecture [Samuelson Multiplier Accelerator](https://python-programming.quantecon.org/samuelson.html).
...
This example provides  machinery that is at the heard of Samuelson’s analysis of his multiplier-accelerator model [[Sam39]](https://python-programming.quantecon.org/zreferences.html#samuelson1939).

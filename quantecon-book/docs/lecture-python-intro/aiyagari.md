...
In this lecture, we describe the structure of a class of models that build on work by Truman Bewley [[Bew77]](https://python-programming.quantecon.org/zreferences.html#bewley1977).
...
- precautionary savings and the effect of liquidity constraints [[Aiy94]](https://python-programming.quantecon.org/zreferences.html#aiyagari1994)  
- risk sharing and asset pricing [[HL96]](https://python-programming.quantecon.org/zreferences.html#heaton1996)  
- the shape of the wealth distribution [[BBZ15]](https://python-programming.quantecon.org/zreferences.html#benhabib2015)  
- etc., etc., etc.  
...
The primary reference for this lecture is [[Aiy94]](https://python-programming.quantecon.org/zreferences.html#aiyagari1994).

A textbook treatment is available in chapter 18 of [[LS18]](https://python-programming.quantecon.org/zreferences.html#ljungqvist2012).

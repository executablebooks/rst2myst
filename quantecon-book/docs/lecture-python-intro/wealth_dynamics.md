...
- See [this lecture](https://python-programming.quantecon.org/heavy_tails.html) for a definition.  
- For a review of the empirical evidence, see, for example, [[BB18]](https://python-programming.quantecon.org/zreferences.html#benhabib2018skewed).  
...
Such spikes are similar to what we observed in time series when [we studied Kesten processes](https://python-programming.quantecon.org/kesten_processes.html).
...
<a id='htop-again'></a>
<img src="https://s3-ap-southeast-2.amazonaws.com/python-programming.quantecon.org/_static/lecture_specific/wealth_dynamics/htop_again.png" style="width:80%;height:80%">
...
The wealth process [(1)](#equation-wealth-dynam-ah) is similar to a [Kesten process](https://python-programming.quantecon.org/kesten_processes.html).
...
If you like, you can use the function `rank_size_plot` from the `quantecon` library (documentation [here](https://quanteconpy.readthedocs.io/en/latest/tools/inequality.html#quantecon.inequality.rank_size_plot)).
